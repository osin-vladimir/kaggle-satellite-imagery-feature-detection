...
def evaluate(models, generators, losses, val_samples=192):
    ...
    # unet_gen = generators.unet_gen_val
    ...
    # unet_loss = unet.evaluate_generator(unet_gen, val_samples)
...
if __name__ == '__main__':
    ...
    params = MyDict({
        ...
        # Train
        'epochs': 14,  # Number of epochs to train the model
        'batch_size': 1,  # The batch size
        'samples_per_batch': 637,  # The number of samples to train each model on each iteration
        'save_every': 1,  # Save results every 'save_every' epochs on the log folder
        'lr': 1e-4,  # The learning rate to train the models
        ...
        'base_dir': 'data/data',  # Directory that contains the data
        ...
        # Image
        'a_ch': 8,  # Number of channels of images A
        'b_ch': 1,  # Number of channels of images B
        'is_a_binary': False,  # If A is binary, its values will be either 0 or 1
        'is_b_binary': True,  # If B is binary, the last layer of the atob model is followed by a sigmoid
        'is_a_grayscale': False,  # If A is grayscale, the image will only have one channel
        'is_b_grayscale': True,  # If B is grayscale, the image will only have one channel
        ...
        'horizontal_flip': True,  # If true performs random horizontal flips on the train set
        'vertical_flip': True,  # If true performs random vertical flips on the train set
