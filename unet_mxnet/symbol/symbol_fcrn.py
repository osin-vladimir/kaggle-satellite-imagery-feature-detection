...
def resnet(units, num_stages, filter_list, num_classes,bottle_neck=True, bn_mom=0.9, workspace=256,
           memonger=False):
    ...
    body = mx.sym.Convolution(data=data, num_filter=filter_list[0],
                              kernel=(5, 5), dilate=(1, 1),
                              stride=(1, 1), pad=(2, 2),
                              no_bias=True, name="conv0", workspace=workspace)

    body = mx.sym.BatchNorm(data=body, fix_gamma=False, eps=2e-5, momentum=bn_mom, name='bn0')
    body = mx.sym.Activation(data=body, act_type='relu', name='relu0')
    body = mx.symbol.Pooling(data=body, kernel=(3, 3), stride=(1, 1), pad=(1, 1), pool_type='max')
...
def get_fcrn_symbol(num_classes, num_layers, conv_workspace=256):
    """
